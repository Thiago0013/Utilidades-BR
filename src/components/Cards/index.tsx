...
export function Cards({title, description, icon: Icon}: CardProps){
    return(
            <div className={'w-60'}>
                ...
                <p className={'text-gray-950 h-20 mt-2'}>{description}</p>
                <div className={'flex justify-center items-center'}>
                    <button className={'bg-blue-700 m-auto cursor-pointer w-50 h-10 rounded-lg hover:brightness-80'}>Acessar</button>
                </div>
            </div>
    );
}